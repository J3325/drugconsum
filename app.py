...
try:
    ...
    # Standarisasi Skala Fitur (DIPISAH AGAR TIDAK TABRAKAN DI SIMULATOR)
    ...
    # 1. Menggabungkan Input untuk Simulator Klasifikasi (12 Kolom)
    ...
    # 2. Persiapan Data untuk Simulator Anomali (Butuh 31 Kolom)
